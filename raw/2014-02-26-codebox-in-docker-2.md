...
layout: post
permalink: >
  http://devblog.yourtech.us/2014/02/26/codebox-in-docker-2/
published: true
---
This is a quick note log. I was able to setup a self-hosted web IDE for programming. Today I tested out codebox.io,
but I also want to check out the open source <a href="https://github.com/dotcloud/hipache">Cloud9 IDE</a>.
