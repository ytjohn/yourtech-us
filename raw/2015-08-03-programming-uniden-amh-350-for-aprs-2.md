...
layout: post
permalink: >
  http://devblog.yourtech.us/2015/08/03/programming-uniden-amh-350-for-aprs-2/
published: true
---
This is a narrative post. If you want to see my python program that calculates out the diode matrix, skip to the end or <a href="http://nbviewer.ipython.org/gist/ytjohn/719504772237953eb28d">click here</a>,

I recently received this "<a href="http://i.imgur.com/mFzoKU5.jpg">Force Communications AMH-350</a>" radio. Actually, it was an entire cabinet with a large power supply, an MFJ TNC2 tnc, and an old DOS PC running JNOS. These had active in a tower shed and turned off 3 years ago. The club wanted me to repurpose this packet system for APRS.
...
Eventually though, I was able to match the book, create a chart that matched the existing programmed 145.050 frequency (both Tx and Rx, which are programmed separately). Then, I wrapped the whole thing up in a set of python functions inside an ipython notebook. You can view this on ipython's <a href="http://nbviewer.ipython.org/gist/ytjohn/719504772237953eb28d">nbviewer</a> or the direct <a href="https://gist.github.com/ytjohn/719504772237953eb28d">gist</a>.
